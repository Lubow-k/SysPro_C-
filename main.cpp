...
#include "8_task/file/FileRW.hpp"
#include "8_task/file/FileRWBuffer.hpp"

#include "8_task/string/StringRW.hpp"
#include "8_task/string/StringRWBuffer.hpp"
...
int main() {
    ...
    FileRWBuffer fsb = FileRWBuffer(in_file, 5);
    fsb.open();
